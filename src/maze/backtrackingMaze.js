...
import visualizeMaze from '../logic/visualizeMaze';

function generateBacktrackingMaze(grid, NUMBER_OF_ROWS, NUMBER_OF_COLS, setisAnimating) {
  clearBoard(grid);
  ...
  visualizeMaze(addWallsToAnimate, 2, removeWallsToAnimate, 30, grid, setisAnimating);
...
export default generateBacktrackingMaze;
